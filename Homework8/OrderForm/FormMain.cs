...
namespace OrderForm
{
    public partial class FormMain : Form
    {
        ...
        public void init()
        {
            Customer customer1 = new Customer(1, "liuwang", "13512345678");
            Customer customer2 = new Customer(2, "jams", "15912345678");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            switch (cbField.SelectedIndex)
            {
                case 0:
                    ...
                    break;
                case 1:
                    orderBindingSource.DataSource = orderService.GetById(txtValue.Text);
                    break;
                case 2:
                    orderBindingSource.DataSource =
        ...
        private void button2_Click(object sender, EventArgs e)
        {
...

            {
                ...
                OrderService.ConvertToHtml(fileName);
